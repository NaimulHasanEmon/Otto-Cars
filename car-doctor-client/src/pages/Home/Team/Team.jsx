  ...
  return (
    <div className='my-10'>
      ...
      <div className='text-center px-4 md:px-20 lg:px-80 flex flex-col gap-3 md:gap-5'>
        <p className='text-lg md:text-xl font-bold text-red-500'>Team</p>
        <p className='text-3xl md:text-4xl font-bold'>Meet Our Team</p>
            ...
            <div className='relative group'>
              <div className='p-6 bg-white'>
                <div className='p-2 flex justify-center'>
                  <img
                    className='h-[220px] rounded-lg object-cover transition-transform duration-300 group-hover:scale-105'
                    src={member.image}
                    alt={member.name}
                  />
                </div>
